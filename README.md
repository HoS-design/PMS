...
- `ReadmeKI2` (Prompt fuer KI-Anleitungen zur Funktionsweise und Modul-Erweiterung)
...
- Englisch: `badge-main is-english` (gruen, siehe `--subject-english`)
- Anderes Fach: `badge-main` oder `badge-main is-andere` und in `:root` `--subject-color` setzen (z.B. `#10b981` fuer Geschichte/Medien).
